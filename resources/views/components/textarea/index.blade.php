...
<textarea {{ $attributes->merge([
    'rows' => '4',
    'class' => 'px-3 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-1 transition-all duration-200 w-full resize-y disabled:opacity-50 disabled:cursor-not-allowed dark:bg-neutral-950 dark:text-neutral-50 dark:placeholder-neutral-500 ' . $borderClass
]) }}>{{ $slot }}</textarea>
